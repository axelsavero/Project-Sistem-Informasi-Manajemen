...
const features = [
  {
    ...
    title: "Lapor Mudah",
    description:
      "Sampaikan pengaduan Anda dengan mengisi formulir sederhana beserta foto pendukung.",
  },
  {
    icon: Search,
    title: "Lacak Status",
    description:
      "Pantau perkembangan laporan Anda secara real-time menggunakan nomor tiket.",
  },
  {
    icon: Clock,
    title: "Respon Cepat",
    description:
      "Pengaduan Anda akan segera ditindaklanjuti oleh petugas terkait.",
  },
  {
    icon: CheckCircle,
    title: "Transparan",
    description:
      "Informasi status pengaduan yang jelas dan dapat dipantau kapan saja.",
  },
];
          ...
          <div className="relative container mx-auto px-4 py-20 md:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-2xl">
                ...
                lingkungan seperti jalan rusak, sampah menumpuk, penerangan
                mati, dan lainnya secara mudah dan transparan.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Sistem pengaduan yang dirancang untuk memudahkan masyarakat
                dalam menyampaikan keluhan dan memantau penanganannya.
              </p>
            </div>
              ...
              {[
                {
                  step: "1",
                  title: "Isi Formulir",
                  desc: "Lengkapi data diri dan detail pengaduan Anda",
                },
                {
                  step: "2",
                  title: "Dapatkan Tiket",
                  desc: "Simpan nomor tiket sebagai bukti pelaporan",
                },
                {
                  step: "3",
                  title: "Pantau Status",
                  desc: "Lacak perkembangan laporan secara real-time",
                },
              ].map((item, index) => (
